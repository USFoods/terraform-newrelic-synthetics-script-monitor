run "verify_policy" {
  ...
  assert {
    condition     = output.policy_name == "Script Browser Condition Policy"
...
run "monitor_configuration" {
  ...
  assert {
    condition     = output.main.name == "Script Browser Condition Synthetic Monitor"
...
run "condition_configuration" {
  ...
  assert {
    condition     = output.main.condition_name == "Script Browser Condition Synthetic Monitor"
