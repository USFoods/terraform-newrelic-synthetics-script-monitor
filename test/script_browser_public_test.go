...
func TestScriptBrowserPublicConfiguration(t *testing.T) {
	...
	// Get module output for account id, enabled, name, type, script, locations, and tags
	...
	// Assert name is set to Script Browser Public Synthetic Monitor
	assert.Equal(t, "Script Browser Public Synthetic Monitor", outputName)
